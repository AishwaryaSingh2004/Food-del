            ...
            {currentOrder?.shopOrders?.map((shopOrder, index) => (
                <div key={index} className='bg-white p-4 rounded-2xl shadow-md border border-orange-100 space-y-4'>
                    <div>
                        ...
                        {shopOrder.deliveryAddress.text}</p>
                    </div>
                </div>
            ))}
        </div>
        ...
        <div className='max-w-4xl mx-auto p-4 flex flex-col gap-6'>
            ...
            {currentOrder?.shopOrders?.map((shopOrder, index) => (
                <div key={index} className='bg-white p-4 rounded-2xl shadow-md border border-orange-100 space-y-4'>
                    ...
                    </>: <p className='text-reen-600 font-semibold text-lg'>Delivered</p>}

{shopOrder.assignedDeliveryBoy &&    <div className='h-[400px] w-full rounded-2xl overflow-hidden shadow-md'> <DeliveryBoyTracking data={{
    deliveryBoyLocation:{
