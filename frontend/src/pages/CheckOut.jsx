...
function CheckOut() {
  ...
  // ✅ SEARCH ADDRESS → LAT LNG (🔥 FIXED CONSOLE)
        ...
        <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6'>
          ...
          <section>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
              ...
              <div
                className={`flex items-center gap-3 rounded-xl border p-4 ${paymentMethod === "cod" ? "border-[#ff4d2d]" : ""}`}
              ...
              <div
                className={`flex items-center gap-3 rounded-xl border p-4 ${paymentMethod === "online" ? "border-[#ff4d2d]" : ""}`}
                onClick={() => setPaymentMethod("online")}
              >

                <span className='inline-flex h-10 w-10 items-center justify-center rounded-full bg-purple-100'><FaMobileAlt className='txt-purple-700 text-lg' />
                </span>
