    ...
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center '>
      ...
      {!myShopData &&
        <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
      ...
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          { myShopData.items.length==0 && <div className='fllex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4 ' />
      ...
      {myShopData && (
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
            ...
            <img
              src={myShopData.image || "https://via.placeholder.com/400"} // ✅ safe fallback
              alt={myShopData.name}
      ...
      {myShopData && (
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
            ...
            {/* IMAGE */}
            <img
              src={myShopData.image || "https://via.placeholder.com/400"}
              alt={myShopData.name}
              className='w-full h-48 sm:h-64 object-cover'
            />
